    ...
    role_crt: {        
        ...
        steps               : [
            ...
            // заполняем объект
            {
                ...
                objectSelector      : '.gd-prop',
                textClass           : 'bottom-center',
                scriptBack          : (ds)=>ds('role', 'create'),                
                scriptBeforeShow    : (ds)=>ds('role', 'createFilled'),                
            },
            ...
            // заполняем объект и фокус на system
            {
                type                : 'step',
            ...
            // заполняем объект и фокус на service
            {
                type                : 'step',
                objectSelector      : '.gd-prp-service',
                textClass           : 'bottom-center',
                showArrow           : true,
                arrowType           : 'h-arrow',
            },
