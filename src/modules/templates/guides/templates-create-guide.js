...
//         description         : 'Данный гайд расскажет как создать шаблона',
...
//                 scriptBeforeShow    : (ds)=>ds('tmpl', 'clearList'),
...
//                 textClass           : 'bottom-center',
//                 scriptBack          : (ds)=>ds('tmpl', 'create'),                
//                 scriptBeforeShow    : (ds)=>ds('tmpl', 'createFilled'),                
//             },
