export default {
    dst_del: {        
        name                : 'Удаление типа хранилища данных',
        description         : 'Данный гайд расскажет про удаление типа хранилища данных',
        sectionPath         : 'dstypes',
        ...
        steps               : [
            // показываем кнопку создания
            {
                ...
                // текст описания шага
                textHtml            : 'Для удаления типа хранилища данных необходимо нажать на кнопку меню в таблице организаций',
                innerSelect         : '.gd-tb-row-item-menu-btn',
                showArrow           : true,
                arrowType           : 'v-arrow',
                arrowText           : 'Вариант 1<br>Меню типа хранилища данных',
            ...
            // контекстное меню таблицы - Удаление 
            {
                ...
                textHtml            : 'Удалить тип хранилища данных можно из данного меню, выбрав пункт "Delete"',
                innerSelect         : '.gd-tb-row-item-menu-delete', 
                showArrow           : true,
                arrowType           : 'h-arrow',
                arrowText           : 'Удаление типа хранилища данных',  
            ...
            // открываем область
            {
                type                : 'step',
                objectSelector      : '.gd-table',
                textHtml            : 'Так же можно выбрать нужные типы хранилища данных нажав на чекбокс в таблице',
