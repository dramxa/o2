export default {
    dst_tb: {        
        name                : 'Тулбар типа хранилища данных',
        description         : 'Данный гайд расскажет какие функции доступны в тулбаре типа хранилища данных',
        sectionPath         : 'dstypes',
        ...
        steps               : [
...

            {
                ...
                showArrow           : true,
                arrowText           : 'Создание типа хранилища данных',
                innerSelect         : '.gd-tb-create',
                feature             : 'ft_dstCreate',
            },
